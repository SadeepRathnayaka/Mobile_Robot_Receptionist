...
{
public:
  MovePoseNode() : Node("pose_to_angle_node"),
                   move_group_interface(std::make_shared<rclcpp::Node>("moveit_node"), "arm")
  {
    ...
    timer_ = this->create_wall_timer(
            ...
            std::bind(&MovePoseNode::timerCallback, this)) ;
...
private:
  ...
  std::pair<bool, std::vector<double>> pose_to_angle(geometry_msgs::msg::Pose target_pose, 
                    moveit::planning_interface::MoveGroupInterface& move_group_interface)
  {
