...
#include "smrr_interfaces/msg/detail/inference_result__rosidl_typesupport_fastrtps_c.h"
...
using _InferenceResult__ros_msg_type = smrr_interfaces__msg__InferenceResult;
...
static uint32_t _InferenceResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__msg__InferenceResult(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smrr_interfaces__msg__InferenceResult;
    is_plain =
      (
...
static size_t _InferenceResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__msg__InferenceResult(
