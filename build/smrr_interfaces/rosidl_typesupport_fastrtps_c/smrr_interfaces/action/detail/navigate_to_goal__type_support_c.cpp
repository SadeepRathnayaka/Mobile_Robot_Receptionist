...
#include "smrr_interfaces/action/detail/navigate_to_goal__rosidl_typesupport_fastrtps_c.h"
...
using _NavigateToGoal_Goal__ros_msg_type = smrr_interfaces__action__NavigateToGoal_Goal;
...
size_t get_serialized_size_smrr_interfaces__action__NavigateToGoal_Goal(
  const void * untyped_ros_message,
...
static uint32_t _NavigateToGoal_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__action__NavigateToGoal_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t max_serialized_size_smrr_interfaces__action__NavigateToGoal_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smrr_interfaces__action__NavigateToGoal_Goal;
    is_plain =
      (
...
static size_t _NavigateToGoal_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__action__NavigateToGoal_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_Goal)() {
...
using _NavigateToGoal_Result__ros_msg_type = smrr_interfaces__action__NavigateToGoal_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t get_serialized_size_smrr_interfaces__action__NavigateToGoal_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavigateToGoal_Result__ros_msg_type * ros_message = static_cast<const _NavigateToGoal_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__action__NavigateToGoal_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t max_serialized_size_smrr_interfaces__action__NavigateToGoal_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces__action__NavigateToGoal_Result;
    is_plain =
      (
...
static size_t _NavigateToGoal_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__action__NavigateToGoal_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_Result)() {
...
using _NavigateToGoal_Feedback__ros_msg_type = smrr_interfaces__action__NavigateToGoal_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t get_serialized_size_smrr_interfaces__action__NavigateToGoal_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavigateToGoal_Feedback__ros_msg_type * ros_message = static_cast<const _NavigateToGoal_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__action__NavigateToGoal_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t max_serialized_size_smrr_interfaces__action__NavigateToGoal_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces__action__NavigateToGoal_Feedback;
    is_plain =
      (
...
static size_t _NavigateToGoal_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__action__NavigateToGoal_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_Feedback)() {
...
// already included above
// #include "smrr_interfaces/action/detail/navigate_to_goal__functions.h"  // goal
...
using _NavigateToGoal_SendGoal_Request__ros_msg_type = smrr_interfaces__action__NavigateToGoal_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t get_serialized_size_smrr_interfaces__action__NavigateToGoal_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavigateToGoal_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _NavigateToGoal_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_smrr_interfaces__action__NavigateToGoal_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__action__NavigateToGoal_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t max_serialized_size_smrr_interfaces__action__NavigateToGoal_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_smrr_interfaces__action__NavigateToGoal_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces__action__NavigateToGoal_SendGoal_Request;
    is_plain =
      (
...
static size_t _NavigateToGoal_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__action__NavigateToGoal_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_SendGoal_Request)() {
...
using _NavigateToGoal_SendGoal_Response__ros_msg_type = smrr_interfaces__action__NavigateToGoal_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t get_serialized_size_smrr_interfaces__action__NavigateToGoal_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavigateToGoal_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _NavigateToGoal_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__action__NavigateToGoal_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t max_serialized_size_smrr_interfaces__action__NavigateToGoal_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces__action__NavigateToGoal_SendGoal_Response;
    is_plain =
      (
...
static size_t _NavigateToGoal_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__action__NavigateToGoal_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_SendGoal)() {
...
using _NavigateToGoal_GetResult_Request__ros_msg_type = smrr_interfaces__action__NavigateToGoal_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t get_serialized_size_smrr_interfaces__action__NavigateToGoal_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavigateToGoal_GetResult_Request__ros_msg_type * ros_message = static_cast<const _NavigateToGoal_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__action__NavigateToGoal_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t max_serialized_size_smrr_interfaces__action__NavigateToGoal_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces__action__NavigateToGoal_GetResult_Request;
    is_plain =
      (
...
static size_t _NavigateToGoal_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__action__NavigateToGoal_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_GetResult_Request)() {
...
// already included above
// #include "smrr_interfaces/action/detail/navigate_to_goal__functions.h"  // result
...
using _NavigateToGoal_GetResult_Response__ros_msg_type = smrr_interfaces__action__NavigateToGoal_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t get_serialized_size_smrr_interfaces__action__NavigateToGoal_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavigateToGoal_GetResult_Response__ros_msg_type * ros_message = static_cast<const _NavigateToGoal_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_smrr_interfaces__action__NavigateToGoal_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__action__NavigateToGoal_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t max_serialized_size_smrr_interfaces__action__NavigateToGoal_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_smrr_interfaces__action__NavigateToGoal_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces__action__NavigateToGoal_GetResult_Response;
    is_plain =
      (
...
static size_t _NavigateToGoal_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__action__NavigateToGoal_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_GetResult)() {
...
// already included above
// #include "smrr_interfaces/action/detail/navigate_to_goal__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _NavigateToGoal_FeedbackMessage__ros_msg_type = smrr_interfaces__action__NavigateToGoal_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t get_serialized_size_smrr_interfaces__action__NavigateToGoal_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavigateToGoal_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _NavigateToGoal_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_smrr_interfaces__action__NavigateToGoal_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__action__NavigateToGoal_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t max_serialized_size_smrr_interfaces__action__NavigateToGoal_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_smrr_interfaces__action__NavigateToGoal_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces__action__NavigateToGoal_FeedbackMessage;
    is_plain =
      (
...
static size_t _NavigateToGoal_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__action__NavigateToGoal_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, action, NavigateToGoal_FeedbackMessage)() {
