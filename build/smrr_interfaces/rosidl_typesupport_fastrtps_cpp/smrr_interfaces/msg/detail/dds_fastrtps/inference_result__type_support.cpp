...
#include "smrr_interfaces/msg/detail/inference_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const smrr_interfaces::msg::InferenceResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smrr_interfaces::msg::InferenceResult & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smrr_interfaces::msg::InferenceResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smrr_interfaces::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smrr_interfaces::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  return &smrr_interfaces::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, msg, InferenceResult)() {
  return &smrr_interfaces::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
