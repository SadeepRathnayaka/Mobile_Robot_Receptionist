...
#include "smrr_interfaces/action/detail/navigate_to_goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const smrr_interfaces::action::NavigateToGoal_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smrr_interfaces::action::NavigateToGoal_Goal & ros_message)
{
  // Member: goal_x
  cdr >> ros_message.goal_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smrr_interfaces::action::NavigateToGoal_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smrr_interfaces::action::NavigateToGoal_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smrr_interfaces::action::NavigateToGoal_Goal *>(
    untyped_ros_message);
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_Goal)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_smrr_interfaces
cdr_serialize(
  const smrr_interfaces::action::NavigateToGoal_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smrr_interfaces::action::NavigateToGoal_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces::action::NavigateToGoal_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smrr_interfaces::action::NavigateToGoal_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<smrr_interfaces::action::NavigateToGoal_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_Result)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_smrr_interfaces
cdr_serialize(
  const smrr_interfaces::action::NavigateToGoal_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smrr_interfaces::action::NavigateToGoal_Feedback & ros_message)
{
  // Member: distance_to_goal
  cdr >> ros_message.distance_to_goal;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces::action::NavigateToGoal_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smrr_interfaces::action::NavigateToGoal_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<smrr_interfaces::action::NavigateToGoal_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_Feedback)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_Feedback__handle;
}
...
// functions for smrr_interfaces::action::NavigateToGoal_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_smrr_interfaces
cdr_serialize(
  const smrr_interfaces::action::NavigateToGoal_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smrr_interfaces::action::NavigateToGoal_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        smrr_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_NavigateToGoal_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces::action::NavigateToGoal_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smrr_interfaces::action::NavigateToGoal_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<smrr_interfaces::action::NavigateToGoal_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_SendGoal_Request)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_smrr_interfaces
cdr_serialize(
  const smrr_interfaces::action::NavigateToGoal_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smrr_interfaces::action::NavigateToGoal_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces::action::NavigateToGoal_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smrr_interfaces::action::NavigateToGoal_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<smrr_interfaces::action::NavigateToGoal_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_SendGoal_Response)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_SendGoal_Response__handle;
}
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_SendGoal)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_smrr_interfaces
cdr_serialize(
  const smrr_interfaces::action::NavigateToGoal_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smrr_interfaces::action::NavigateToGoal_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces::action::NavigateToGoal_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smrr_interfaces::action::NavigateToGoal_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<smrr_interfaces::action::NavigateToGoal_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_GetResult_Request)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for smrr_interfaces::action::NavigateToGoal_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_smrr_interfaces
cdr_serialize(
  const smrr_interfaces::action::NavigateToGoal_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smrr_interfaces::action::NavigateToGoal_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        smrr_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_NavigateToGoal_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces::action::NavigateToGoal_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smrr_interfaces::action::NavigateToGoal_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<smrr_interfaces::action::NavigateToGoal_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_GetResult_Response)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_GetResult_Response__handle;
}
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_GetResult)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_GetResult__handle;
}
...
// functions for smrr_interfaces::action::NavigateToGoal_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_smrr_interfaces
cdr_serialize(
  const smrr_interfaces::action::NavigateToGoal_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smrr_interfaces::action::NavigateToGoal_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        smrr_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_NavigateToGoal_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smrr_interfaces::action::NavigateToGoal_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smrr_interfaces::action::NavigateToGoal_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<smrr_interfaces::action::NavigateToGoal_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, action, NavigateToGoal_FeedbackMessage)() {
  return &smrr_interfaces::action::typesupport_fastrtps_cpp::_NavigateToGoal_FeedbackMessage__handle;
}
