...
static const _InferenceResult_type_support_symbol_names_t _InferenceResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smrr_interfaces, msg, InferenceResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smrr_interfaces, msg, InferenceResult)),
  }
};
...
{
  return &::smrr_interfaces::msg::rosidl_typesupport_cpp::InferenceResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smrr_interfaces, msg, InferenceResult)() {
  return get_message_type_support_handle<smrr_interfaces::msg::InferenceResult>();
}
