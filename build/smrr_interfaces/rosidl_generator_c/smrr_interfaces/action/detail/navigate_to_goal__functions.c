...
smrr_interfaces__action__NavigateToGoal_Goal__create()
{
  ...
  smrr_interfaces__action__NavigateToGoal_Goal * msg = (smrr_interfaces__action__NavigateToGoal_Goal *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smrr_interfaces__action__NavigateToGoal_Goal));
  bool success = smrr_interfaces__action__NavigateToGoal_Goal__init(msg);
  if (!success) {
...
smrr_interfaces__action__NavigateToGoal_Goal__destroy(smrr_interfaces__action__NavigateToGoal_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    smrr_interfaces__action__NavigateToGoal_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_Goal__Sequence__init(smrr_interfaces__action__NavigateToGoal_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_Goal * data = NULL;

  if (size) {
    data = (smrr_interfaces__action__NavigateToGoal_Goal *)allocator.zero_allocate(size, sizeof(smrr_interfaces__action__NavigateToGoal_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smrr_interfaces__action__NavigateToGoal_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        smrr_interfaces__action__NavigateToGoal_Goal__fini(&data[i - 1]);
      }
...
smrr_interfaces__action__NavigateToGoal_Goal__Sequence__fini(smrr_interfaces__action__NavigateToGoal_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      smrr_interfaces__action__NavigateToGoal_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_Goal__Sequence * array = (smrr_interfaces__action__NavigateToGoal_Goal__Sequence *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smrr_interfaces__action__NavigateToGoal_Goal__Sequence__init(array, size);
  if (!success) {
...
smrr_interfaces__action__NavigateToGoal_Goal__Sequence__destroy(smrr_interfaces__action__NavigateToGoal_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smrr_interfaces__action__NavigateToGoal_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_Goal__Sequence__are_equal(const smrr_interfaces__action__NavigateToGoal_Goal__Sequence * lhs, const smrr_interfaces__action__NavigateToGoal_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smrr_interfaces__action__NavigateToGoal_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smrr_interfaces__action__NavigateToGoal_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smrr_interfaces__action__NavigateToGoal_Goal * data =
      (smrr_interfaces__action__NavigateToGoal_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smrr_interfaces__action__NavigateToGoal_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smrr_interfaces__action__NavigateToGoal_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_Result * msg = (smrr_interfaces__action__NavigateToGoal_Result *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smrr_interfaces__action__NavigateToGoal_Result));
  bool success = smrr_interfaces__action__NavigateToGoal_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_Result__destroy(smrr_interfaces__action__NavigateToGoal_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    smrr_interfaces__action__NavigateToGoal_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_Result__Sequence__init(smrr_interfaces__action__NavigateToGoal_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_Result * data = NULL;

  if (size) {
    data = (smrr_interfaces__action__NavigateToGoal_Result *)allocator.zero_allocate(size, sizeof(smrr_interfaces__action__NavigateToGoal_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smrr_interfaces__action__NavigateToGoal_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        smrr_interfaces__action__NavigateToGoal_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_Result__Sequence__fini(smrr_interfaces__action__NavigateToGoal_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      smrr_interfaces__action__NavigateToGoal_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_Result__Sequence * array = (smrr_interfaces__action__NavigateToGoal_Result__Sequence *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smrr_interfaces__action__NavigateToGoal_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_Result__Sequence__destroy(smrr_interfaces__action__NavigateToGoal_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smrr_interfaces__action__NavigateToGoal_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_Result__Sequence__are_equal(const smrr_interfaces__action__NavigateToGoal_Result__Sequence * lhs, const smrr_interfaces__action__NavigateToGoal_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smrr_interfaces__action__NavigateToGoal_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smrr_interfaces__action__NavigateToGoal_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smrr_interfaces__action__NavigateToGoal_Result * data =
      (smrr_interfaces__action__NavigateToGoal_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smrr_interfaces__action__NavigateToGoal_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smrr_interfaces__action__NavigateToGoal_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_Feedback * msg = (smrr_interfaces__action__NavigateToGoal_Feedback *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smrr_interfaces__action__NavigateToGoal_Feedback));
  bool success = smrr_interfaces__action__NavigateToGoal_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_Feedback__destroy(smrr_interfaces__action__NavigateToGoal_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    smrr_interfaces__action__NavigateToGoal_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_Feedback__Sequence__init(smrr_interfaces__action__NavigateToGoal_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_Feedback * data = NULL;

  if (size) {
    data = (smrr_interfaces__action__NavigateToGoal_Feedback *)allocator.zero_allocate(size, sizeof(smrr_interfaces__action__NavigateToGoal_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smrr_interfaces__action__NavigateToGoal_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        smrr_interfaces__action__NavigateToGoal_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_Feedback__Sequence__fini(smrr_interfaces__action__NavigateToGoal_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      smrr_interfaces__action__NavigateToGoal_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_Feedback__Sequence * array = (smrr_interfaces__action__NavigateToGoal_Feedback__Sequence *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smrr_interfaces__action__NavigateToGoal_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_Feedback__Sequence__destroy(smrr_interfaces__action__NavigateToGoal_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smrr_interfaces__action__NavigateToGoal_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_Feedback__Sequence__are_equal(const smrr_interfaces__action__NavigateToGoal_Feedback__Sequence * lhs, const smrr_interfaces__action__NavigateToGoal_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smrr_interfaces__action__NavigateToGoal_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smrr_interfaces__action__NavigateToGoal_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smrr_interfaces__action__NavigateToGoal_Feedback * data =
      (smrr_interfaces__action__NavigateToGoal_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smrr_interfaces__action__NavigateToGoal_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smrr_interfaces__action__NavigateToGoal_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Request__init(smrr_interfaces__action__NavigateToGoal_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    smrr_interfaces__action__NavigateToGoal_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!smrr_interfaces__action__NavigateToGoal_Goal__init(&msg->goal)) {
    smrr_interfaces__action__NavigateToGoal_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Request__fini(smrr_interfaces__action__NavigateToGoal_SendGoal_Request * msg)
{
  ...
  // goal
  smrr_interfaces__action__NavigateToGoal_Goal__fini(&msg->goal);
}
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Request__are_equal(const smrr_interfaces__action__NavigateToGoal_SendGoal_Request * lhs, const smrr_interfaces__action__NavigateToGoal_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!smrr_interfaces__action__NavigateToGoal_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_SendGoal_Request * msg = (smrr_interfaces__action__NavigateToGoal_SendGoal_Request *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Request));
  bool success = smrr_interfaces__action__NavigateToGoal_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence__init(smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_SendGoal_Request * data = NULL;

  if (size) {
    data = (smrr_interfaces__action__NavigateToGoal_SendGoal_Request *)allocator.zero_allocate(size, sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smrr_interfaces__action__NavigateToGoal_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        smrr_interfaces__action__NavigateToGoal_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence__fini(smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      smrr_interfaces__action__NavigateToGoal_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence * array = (smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence__destroy(smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence__are_equal(const smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence * lhs, const smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smrr_interfaces__action__NavigateToGoal_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smrr_interfaces__action__NavigateToGoal_SendGoal_Request * data =
      (smrr_interfaces__action__NavigateToGoal_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smrr_interfaces__action__NavigateToGoal_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smrr_interfaces__action__NavigateToGoal_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Response__init(smrr_interfaces__action__NavigateToGoal_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    smrr_interfaces__action__NavigateToGoal_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_SendGoal_Response * msg = (smrr_interfaces__action__NavigateToGoal_SendGoal_Response *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Response));
  bool success = smrr_interfaces__action__NavigateToGoal_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence__init(smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_SendGoal_Response * data = NULL;

  if (size) {
    data = (smrr_interfaces__action__NavigateToGoal_SendGoal_Response *)allocator.zero_allocate(size, sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smrr_interfaces__action__NavigateToGoal_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        smrr_interfaces__action__NavigateToGoal_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence__fini(smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      smrr_interfaces__action__NavigateToGoal_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence * array = (smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence__destroy(smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence__are_equal(const smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence * lhs, const smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smrr_interfaces__action__NavigateToGoal_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smrr_interfaces__action__NavigateToGoal_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smrr_interfaces__action__NavigateToGoal_SendGoal_Response * data =
      (smrr_interfaces__action__NavigateToGoal_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smrr_interfaces__action__NavigateToGoal_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smrr_interfaces__action__NavigateToGoal_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_GetResult_Request__init(smrr_interfaces__action__NavigateToGoal_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    smrr_interfaces__action__NavigateToGoal_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_GetResult_Request * msg = (smrr_interfaces__action__NavigateToGoal_GetResult_Request *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Request));
  bool success = smrr_interfaces__action__NavigateToGoal_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence__init(smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_GetResult_Request * data = NULL;

  if (size) {
    data = (smrr_interfaces__action__NavigateToGoal_GetResult_Request *)allocator.zero_allocate(size, sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smrr_interfaces__action__NavigateToGoal_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        smrr_interfaces__action__NavigateToGoal_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence__fini(smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      smrr_interfaces__action__NavigateToGoal_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence * array = (smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence__destroy(smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence__are_equal(const smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence * lhs, const smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smrr_interfaces__action__NavigateToGoal_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smrr_interfaces__action__NavigateToGoal_GetResult_Request * data =
      (smrr_interfaces__action__NavigateToGoal_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smrr_interfaces__action__NavigateToGoal_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smrr_interfaces__action__NavigateToGoal_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_GetResult_Response__init(smrr_interfaces__action__NavigateToGoal_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!smrr_interfaces__action__NavigateToGoal_Result__init(&msg->result)) {
    smrr_interfaces__action__NavigateToGoal_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
smrr_interfaces__action__NavigateToGoal_GetResult_Response__fini(smrr_interfaces__action__NavigateToGoal_GetResult_Response * msg)
{
  ...
  // status
  // result
  smrr_interfaces__action__NavigateToGoal_Result__fini(&msg->result);
}
...
smrr_interfaces__action__NavigateToGoal_GetResult_Response__are_equal(const smrr_interfaces__action__NavigateToGoal_GetResult_Response * lhs, const smrr_interfaces__action__NavigateToGoal_GetResult_Response * rhs)
{
  ...
  // result
  if (!smrr_interfaces__action__NavigateToGoal_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_GetResult_Response * msg = (smrr_interfaces__action__NavigateToGoal_GetResult_Response *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Response));
  bool success = smrr_interfaces__action__NavigateToGoal_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence__init(smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_GetResult_Response * data = NULL;

  if (size) {
    data = (smrr_interfaces__action__NavigateToGoal_GetResult_Response *)allocator.zero_allocate(size, sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smrr_interfaces__action__NavigateToGoal_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        smrr_interfaces__action__NavigateToGoal_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence__fini(smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      smrr_interfaces__action__NavigateToGoal_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence * array = (smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence__destroy(smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence__are_equal(const smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence * lhs, const smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smrr_interfaces__action__NavigateToGoal_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smrr_interfaces__action__NavigateToGoal_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smrr_interfaces__action__NavigateToGoal_GetResult_Response * data =
      (smrr_interfaces__action__NavigateToGoal_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smrr_interfaces__action__NavigateToGoal_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smrr_interfaces__action__NavigateToGoal_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_FeedbackMessage__init(smrr_interfaces__action__NavigateToGoal_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    smrr_interfaces__action__NavigateToGoal_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!smrr_interfaces__action__NavigateToGoal_Feedback__init(&msg->feedback)) {
    smrr_interfaces__action__NavigateToGoal_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
smrr_interfaces__action__NavigateToGoal_FeedbackMessage__fini(smrr_interfaces__action__NavigateToGoal_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  smrr_interfaces__action__NavigateToGoal_Feedback__fini(&msg->feedback);
}
...
smrr_interfaces__action__NavigateToGoal_FeedbackMessage__are_equal(const smrr_interfaces__action__NavigateToGoal_FeedbackMessage * lhs, const smrr_interfaces__action__NavigateToGoal_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!smrr_interfaces__action__NavigateToGoal_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_FeedbackMessage * msg = (smrr_interfaces__action__NavigateToGoal_FeedbackMessage *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smrr_interfaces__action__NavigateToGoal_FeedbackMessage));
  bool success = smrr_interfaces__action__NavigateToGoal_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence__init(smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_FeedbackMessage * data = NULL;

  if (size) {
    data = (smrr_interfaces__action__NavigateToGoal_FeedbackMessage *)allocator.zero_allocate(size, sizeof(smrr_interfaces__action__NavigateToGoal_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smrr_interfaces__action__NavigateToGoal_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        smrr_interfaces__action__NavigateToGoal_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence__fini(smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      smrr_interfaces__action__NavigateToGoal_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence * array = (smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence *)allocator.allocate(sizeof(smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence__destroy(smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence__are_equal(const smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence * lhs, const smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smrr_interfaces__action__NavigateToGoal_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smrr_interfaces__action__NavigateToGoal_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smrr_interfaces__action__NavigateToGoal_FeedbackMessage * data =
      (smrr_interfaces__action__NavigateToGoal_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smrr_interfaces__action__NavigateToGoal_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smrr_interfaces__action__NavigateToGoal_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!smrr_interfaces__action__NavigateToGoal_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
