...
bool smrr_interfaces__msg__inference_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smrr_interfaces.msg._inference_result.InferenceResult", full_classname_dest, 53) == 0);
  }
  smrr_interfaces__msg__InferenceResult * ros_message = _ros_message;
  {  // class_name
...
PyObject * smrr_interfaces__msg__inference_result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("smrr_interfaces.msg._inference_result");
